...
export const buttonVariants = cva('disabled:pointer-events-none', {
  variants: {
    variant: {
      ...
      edit: 'flex h-7 w-7 items-center justify-center rounded-lg border-[#5f63f2] bg-[#5f63f2] text-base font-medium text-gray-900 duration-300 hover:border-[#8c94ff] hover:bg-[#8c94ff] hover:text-white',
    },
  },
  defaultVariants: {
    variant: 'base',
